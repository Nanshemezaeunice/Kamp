    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Browse humanitarian projects and find causes to support.</p>
        </div>
        <button 
      ...
      {loading ? (
        ...
        projects.length === 0 ? (
          <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-500">There are no projects on the platform yet. Check back soon!</p>
          </div>
        ) : (
              ...
              return (
                <div key={p._id} className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition group">
                  <div className="cursor-pointer" onClick={() => handleCardClick(p)}>
                    {p.image && <img src={p.image} alt={p.name || p.title} className="w-full h-40 object-cover" />}
